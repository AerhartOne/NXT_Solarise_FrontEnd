      ...
      <form className='form-group w-100'>
        ...
        <div className='modal-body'>
          <div className='container-fluid mx-0 my-0 px-3 py-0'>
              ...
              <input className='input-group-text w-100 my-3' type='email' autoComplete='username' id='input-email' onChange={this.onDataChanged} placeholder='Email' />
              <input className='input-group-text w-100 my-3' type='password' autoComplete='new-password' id='input-password' onChange={this.onDataChanged} placeholder='Password' />
              <div className='container-fluid d-flex flex-row px-0 py-0 my-3'>
                <div className='col w-100 px-0 py-0'>
                  <input className='input-group-text w-100 my-0' type='text' id='input-first-name' onChange={this.onDataChanged} placeholder='First Name' />
                </div>
                <div className='col w-100 px-0 py-0'>
                  <input className='input-group-text w-100 my-0' type='text' id='input-last-name' onChange={this.onDataChanged} placeholder='Last Name' />
                </div>
              </div>
          </div>
        </div>
